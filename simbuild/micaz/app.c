...
typedef TMilli testCorrC$Timer0$precision_tag;
typedef TMilli testCorrC$Timer1$precision_tag;
...
static void testCorrC$Timer0$fired(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void testCorrC$AMControl$startDone(error_t error);
#line 138
static void testCorrC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void testCorrC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void testCorrC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void testCorrC$Timer1$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 36 "BitVecUtilsC.nc"
static inline error_t BitVecUtilsC$BitVecUtils$indexOf(uint16_t *pResult, uint16_t fromIndex, 
uint8_t *bitVec, uint16_t length);
#line 94
static inline error_t BitVecUtilsC$BitVecUtils$countOnes(uint16_t *pResult, uint8_t *bitVec, uint16_t length);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void testCorrC$Timer0$startPeriodic(uint32_t dt);
#line 78
static void testCorrC$Timer0$stop(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t testCorrC$AMControl$start(void );
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t testCorrC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void testCorrC$Timer1$startOneShot(uint32_t dt);




static void testCorrC$Timer1$stop(void );
# 39 "BitVecUtils.nc"
static error_t testCorrC$BitVecUtils$indexOf(uint16_t *pResult, uint16_t fromIndex, 
uint8_t *bitVec, uint16_t length);
...
static error_t testCorrC$BitVecUtils$countOnes(uint16_t *pResult, uint8_t *bitVec, 
uint16_t length);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void testCorrC$Leds$led0Toggle(void );
# 20 "testCorrC.nc"
uint16_t testCorrC$nextPkt[1000];
uint16_t testCorrC$ones[1000];
uint8_t testCorrC$txBv[1000][BIT_VEC_SIZE];
uint8_t testCorrC$rxBv[1000][BIT_VEC_SIZE];
bool testCorrC$busy[1000];
bool testCorrC$finish[1000];
message_t testCorrC$pkt[1000];
uint8_t testCorrC$i[1000];
uint8_t testCorrC$dup[1000][TOTAL_PKTS][1];
uint16_t testCorrC$txCnt[1000];

static inline void testCorrC$Boot$booted(void );



static inline void testCorrC$AMControl$startDone(error_t err);
#line 60
static inline void testCorrC$AMControl$stopDone(error_t err);


static inline void testCorrC$Timer0$fired(void );
#line 86
static inline message_t *testCorrC$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 129
static inline void testCorrC$Timer1$fired(void );
#line 150
static void testCorrC$AMSend$sendDone(message_t *msg, error_t error);
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void testCorrC$Timer0$startPeriodic(uint32_t dt){
#line 64
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void testCorrC$Timer1$startOneShot(uint32_t dt){
#line 73
...
inline static void testCorrC$Timer1$stop(void ){
#line 78
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void testCorrC$Leds$led0Toggle(void ){
#line 67
...
# 51 "BitVecUtils.nc"
inline static error_t testCorrC$BitVecUtils$countOnes(uint16_t *pResult, uint8_t *bitVec, uint16_t length){
#line 51
  unsigned char __nesc_result;
#line 51
...
#line 86
{
  if (len == sizeof(testCorrDataMsg )) {
      testCorrDataMsg *btrpkt = (testCorrDataMsg *)payload;

#line 89
      if ((testCorrC$rxBv[sim_node()][__nesc_ntoh_uint16(btrpkt->seqno.nxdata) / 8] & (1 << __nesc_ntoh_uint16(btrpkt->seqno.nxdata) % 8)) == 0) {
          sim_log_debug(161U, "CORR", "pkt %d dupped.\n", __nesc_ntoh_uint16(btrpkt->seqno.nxdata));
          testCorrC$dup[sim_node()][__nesc_ntoh_uint16(btrpkt->seqno.nxdata)][0]++;
        }
      else {
          sim_log_debug(162U, "CORR", "pkt %d received.\n", __nesc_ntoh_uint16(btrpkt->seqno.nxdata));
          testCorrC$rxBv[sim_node()][__nesc_ntoh_uint16(btrpkt->seqno.nxdata) / 8] = testCorrC$rxBv[sim_node()][__nesc_ntoh_uint16(btrpkt->seqno.nxdata) / 8] & ~(1 << __nesc_ntoh_uint16(btrpkt->seqno.nxdata) % 8);
        }
      testCorrC$BitVecUtils$countOnes(&testCorrC$ones[sim_node()], testCorrC$rxBv[sim_node()], TOTAL_PKTS);
      if (testCorrC$ones[sim_node()] == 0) {


          testCorrC$finish[sim_node()] = TRUE;
          sim_log_debug(163U, "CORR", "all pkts received. dup list:\n**********\n");
          testCorrC$Leds$led0Toggle();
          for (testCorrC$i[sim_node()] = 0; testCorrC$i[sim_node()] < TOTAL_PKTS; testCorrC$i[sim_node()]++) {
              if (testCorrC$dup[sim_node()][testCorrC$i[sim_node()]][0] != 0) {
                  sim_log_debug(164U, "CORR", "%d:%d,  \n", testCorrC$i[sim_node()], testCorrC$dup[sim_node()][testCorrC$i[sim_node()]][0]);
                }
            }

          sim_log_debug(165U, "CORR", "\n**********\n");
        }


      testCorrC$Timer1$stop();
      testCorrC$Timer1$startOneShot(3 * TIMER_PERIOD_MILLI);
    }

  if (len == sizeof(testCorrReqMsg ) && TOS_NODE_ID == 1) {
      testCorrReqMsg *btrpkt = (testCorrReqMsg *)payload;

      for (testCorrC$i[sim_node()] = 0; testCorrC$i[sim_node()] < BIT_VEC_SIZE; testCorrC$i[sim_node()]++) {
          testCorrC$txBv[sim_node()][testCorrC$i[sim_node()]] |= __nesc_ntoh_uint8(btrpkt->bv[testCorrC$i[sim_node()]].nxdata) & ~testCorrC$txBv[sim_node()][testCorrC$i[sim_node()]];
        }
      testCorrC$Timer0$startPeriodic(TIMER_PERIOD_MILLI);
    }
  return msg;
}
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408cbac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408cbac8) {
#line 78
    case 6:
#line 78
      __nesc_result = testCorrC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408cbac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408c9178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408c9178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t testCorrC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 35
{
  sim_log_debug(158U, "CORR", "node id: %d\n", TOS_NODE_ID);
  for (testCorrC$i[sim_node()] = 0; testCorrC$i[sim_node()] < BIT_VEC_SIZE; testCorrC$i[sim_node()]++) {
      if (TOS_NODE_ID == 1) {
          testCorrC$finish[sim_node()] = TRUE;
          testCorrC$txCnt[sim_node()] = 0;
          testCorrC$txBv[sim_node()][testCorrC$i[sim_node()]] = 0xff;
          testCorrC$rxBv[sim_node()][testCorrC$i[sim_node()]] = 0x00;
        }
      else {
          testCorrC$txBv[sim_node()][testCorrC$i[sim_node()]] = 0x00;
          testCorrC$rxBv[sim_node()][testCorrC$i[sim_node()]] = 0xff;
          testCorrC$dup[sim_node()][testCorrC$i[sim_node()]][0] = 0;
        }
    }
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 1) {
...
#line 113
  testCorrC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  testCorrC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408cb108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x408cb108, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  testCorrC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40bf1010, message_t * msg, error_t error){
#line 100
  switch (arg_0x40bf1010) {
#line 100
    case 0U:
#line 100
      /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40bf1010, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40bf19f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40bf19f8, addr, msg, len);
#line 80
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t testCorrC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * testCorrC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 129
{
  ...
  if (!testCorrC$finish[sim_node()]) {
      sim_log_debug(166U, "CORR", "Not finished, Prepare req msgs!\n");
      if (!testCorrC$busy[sim_node()]) {
          testCorrReqMsg *btrpkt = (testCorrReqMsg *)testCorrC$Packet$getPayload(&testCorrC$pkt[sim_node()], sizeof(testCorrReqMsg ));

#line 135
          if (btrpkt == (void *)0) {
              sim_log_debug(167U, "CORR", "REPORT NULL\n");
              return;
            }
          __nesc_hton_uint8(btrpkt->dest.nxdata, 1);
          __nesc_hton_uint8(btrpkt->nodeid.nxdata, TOS_NODE_ID);
          memcpy(btrpkt->bv, testCorrC$rxBv[sim_node()], BIT_VEC_SIZE);

          if (
#line 142
          testCorrC$AMSend$send(AM_BROADCAST_ADDR, 
          &testCorrC$pkt[sim_node()], sizeof(testCorrReqMsg )) == SUCCESS) {
              testCorrC$busy[sim_node()] = 1;
            }
        }
    }
}
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void testCorrC$Timer0$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(0U);
#line 78
}
...
# 39 "BitVecUtils.nc"
inline static error_t testCorrC$BitVecUtils$indexOf(uint16_t *pResult, uint16_t fromIndex, uint8_t *bitVec, uint16_t length){
#line 39
  unsigned char __nesc_result;
#line 39
...
#line 63
{
  ...
  if (testCorrC$BitVecUtils$indexOf(&testCorrC$nextPkt[sim_node()], 0, testCorrC$txBv[sim_node()], TOTAL_PKTS) != SUCCESS) {


      sim_log_debug(159U, "CORR", "Send Done, total count: %d\n", testCorrC$txCnt[sim_node()]);
      testCorrC$Timer0$stop();
    }
  else 
#line 72
    {
      if (!testCorrC$busy[sim_node()]) {
          testCorrDataMsg *btrpkt = (testCorrDataMsg *)testCorrC$Packet$getPayload(&testCorrC$pkt[sim_node()], sizeof(testCorrDataMsg ));

#line 75
          __nesc_hton_uint8(btrpkt->nodeid.nxdata, TOS_NODE_ID);
          __nesc_hton_uint16(btrpkt->seqno.nxdata, testCorrC$nextPkt[sim_node()]);
          sim_log_debug(160U, "CORR", "sending %d th packet.\n", testCorrC$nextPkt[sim_node()]);
          if (testCorrC$AMSend$send(AM_BROADCAST_ADDR, &testCorrC$pkt[sim_node()], sizeof(testCorrDataMsg )) == SUCCESS) {
              testCorrC$busy[sim_node()] = TRUE;
            }
          testCorrC$txBv[sim_node()][testCorrC$nextPkt[sim_node()] / 8] = testCorrC$txBv[sim_node()][testCorrC$nextPkt[sim_node()] / 8] & ~(1 << testCorrC$nextPkt[sim_node()] % 8);
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40ba7c70){
#line 83
  switch (arg_0x40ba7c70) {
#line 83
    case 0U:
#line 83
      testCorrC$Timer0$fired();
#line 83
      testCorrC$Timer1$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40ba7c70);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 150
{
  if (&testCorrC$pkt[sim_node()] == msg) {
      testCorrC$busy[sim_node()] = FALSE;
      if (TOS_NODE_ID == 1) {
          testCorrC$txCnt[sim_node()]++;
        }
    }
...
#line 55
{
  /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*testCorrAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module testCorrC */
  if (!strcmp(varname, "testCorrC$nextPkt"))
  {
    *addr = (uintptr_t)&testCorrC$nextPkt[__nesc_mote];
    *size = sizeof(testCorrC$nextPkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$ones"))
  {
    *addr = (uintptr_t)&testCorrC$ones[__nesc_mote];
    *size = sizeof(testCorrC$ones[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$txBv"))
  {
    *addr = (uintptr_t)&testCorrC$txBv[__nesc_mote];
    *size = sizeof(testCorrC$txBv[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$rxBv"))
  {
    *addr = (uintptr_t)&testCorrC$rxBv[__nesc_mote];
    *size = sizeof(testCorrC$rxBv[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$busy"))
  {
    *addr = (uintptr_t)&testCorrC$busy[__nesc_mote];
    *size = sizeof(testCorrC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$finish"))
  {
    *addr = (uintptr_t)&testCorrC$finish[__nesc_mote];
    *size = sizeof(testCorrC$finish[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$pkt"))
  {
    *addr = (uintptr_t)&testCorrC$pkt[__nesc_mote];
    *size = sizeof(testCorrC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$i"))
  {
    *addr = (uintptr_t)&testCorrC$i[__nesc_mote];
    *size = sizeof(testCorrC$i[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$dup"))
  {
    *addr = (uintptr_t)&testCorrC$dup[__nesc_mote];
    *size = sizeof(testCorrC$dup[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "testCorrC$txCnt"))
  {
    *addr = (uintptr_t)&testCorrC$txCnt[__nesc_mote];
    *size = sizeof(testCorrC$txCnt[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module testCorrC */
  memset((void *)&testCorrC$nextPkt[__nesc_mote], 0, sizeof testCorrC$nextPkt[__nesc_mote]);
  memset((void *)&testCorrC$ones[__nesc_mote], 0, sizeof testCorrC$ones[__nesc_mote]);
  memset((void *)&testCorrC$txBv[__nesc_mote], 0, sizeof testCorrC$txBv[__nesc_mote]);
  memset((void *)&testCorrC$rxBv[__nesc_mote], 0, sizeof testCorrC$rxBv[__nesc_mote]);
  testCorrC$busy[__nesc_mote] = FALSE;
  testCorrC$finish[__nesc_mote] = FALSE;
  memset((void *)&testCorrC$pkt[__nesc_mote], 0, sizeof testCorrC$pkt[__nesc_mote]);
  memset((void *)&testCorrC$i[__nesc_mote], 0, sizeof testCorrC$i[__nesc_mote]);
  memset((void *)&testCorrC$dup[__nesc_mote], 0, sizeof testCorrC$dup[__nesc_mote]);
  memset((void *)&testCorrC$txCnt[__nesc_mote], 0, sizeof testCorrC$txCnt[__nesc_mote]);
